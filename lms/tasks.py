...
def send_course_update_notifications(course_id, updated_lesson_id=None):
    ...
    try:
        ...
        logger.info(f'Уведомления отправлены. Успешно: {successful_sends}, Неудачно: {failed_sends}')
...
def send_daily_statistics():
    ...
    try:
        ...
        # HTML версия
        html_message = render_to_string('emails/daily_statistics.html', {
...
@shared_task
def check_and_send_course_update_notifications(course_id, updated_lesson_id=None, force_send=False):
    """

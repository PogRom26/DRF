...
urlpatterns = [
    ...
    path('<int:payment_id>/stripe-status/', StripePaymentStatusAPIView.as_view(), name='stripe-payment-status'),
    path('course/<int:course_id>/stripe-payment/', CreateStripePaymentForCourseAPIView.as_view(),
